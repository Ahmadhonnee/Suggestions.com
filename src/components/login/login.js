...
export const Login = () => {
  ...
  const handleLoginForm = (evt) => {
    ...
    const { login_name, login_password } = evt.target.elements;

    setLoginAuth([{ login_name, login_password }]);
    navigate("/");
  };

  return (
    <div className="login">
      <form className="form" onSubmit={handleLoginForm} autoComplete="off">
        <div className="form-inner">
          <h2 className="form-title">User Login</h2>
          <div className="input-wrapper">
            <label htmlFor="login-username label">Username</label>
          ...
          <div className="input-wrapper">
            <label htmlFor="login-password label">Password</label>
            <div className="input-group">
              <span className="icon">
                <svg viewBox="0 0 24 24">
